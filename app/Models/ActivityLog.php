...
class ActivityLog extends Model
{
    ...
    public function actionBadgeClass(): string
    {
        return match ($this->normalizedAction()) {
            ...
            'update', 'email', 'test_email', 'download_file' => 'bg-gradient-info',
            'reply' => 'bg-gradient-info',
            'mark_replied', 'status_change' => 'bg-gradient-success',
            'delete' => 'bg-gradient-danger',
            'reject' => 'bg-gradient-warning',
    ...
    public function structuredDescription(): string
    {
        ...
        $verb = match ($this->normalizedAction()) {
            ...
            'approve' => 'Menyetujui',
            'reject' => 'Menolak',
            'reply', 'mark_replied' => 'Mengirim balasan',
            'email', 'test_email' => 'Mengirim email',
