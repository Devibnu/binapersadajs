...
class StoreInquiryQuotationRequest extends FormRequest
{
    ...
    {
        return auth()->check() && auth()->user()->canAccess('inquiry-quotation.create');
    }
    ...
    public function rules(): array
    {
        return [
            ...
            // Quotation
            'quotation_number' => ['nullable', 'string', 'max:50', 'unique:inquiry_quotations,quotation_number'],
