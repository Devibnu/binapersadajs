...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    @php
      ...
      $hasSystemMenus = $can('email-settings.view') || $can('email-templates.view') || $can('email-center.view') || $can('roles.view') || $can('users.view') || $adminUser;
    @endphp
    <ul class="navbar-nav">
      ...
      @if($hasContentMenus)
        ...
        @endif
        @if($can('trading-products.view'))
          <li class="nav-item"><a class="nav-link {{ Request::is('paneladmin/trading-products*') ? 'active' : '' }}" href="{{ route('paneladmin.trading-products.index') }}"><div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"><i class="fas fa-box-open text-sm opacity-10 {{ Request::is('paneladmin/trading-products*') ? 'text-white' : 'text-dark' }}"></i></div><span class="nav-link-text ms-1">Trading Products</span></a></li>
        @endif
        @if($can('blogs.view'))
      ...
      @if($hasCommunicationMenus)
        ...
        @endif
        @if($can('project-reports.view'))
          <li class="nav-item"><a class="nav-link {{ Request::is('paneladmin/project-reports*') ? 'active' : '' }}" href="{{ route('paneladmin.project-reports.index') }}"><div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"><i class="fas fa-clipboard-list text-sm opacity-10 {{ Request::is('paneladmin/project-reports*') ? 'text-white' : 'text-dark' }}"></i></div><span class="nav-link-text ms-1">Project Reports</span></a></li>
        @endif
        @if($can('invoice-reports.view'))
          <li class="nav-item"><a class="nav-link {{ Request::is('paneladmin/invoice-reports*') ? 'active' : '' }}" href="{{ route('paneladmin.invoice-reports.index') }}"><div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"><i class="fas fa-file-invoice-dollar text-sm opacity-10 {{ Request::is('paneladmin/invoice-reports*') ? 'text-white' : 'text-dark' }}"></i></div><span class="nav-link-text ms-1">Invoice Reports</span></a></li>
        @endif
      ...
      @if($hasSystemMenus)
        ...
        @endif
        @if($can('email-center.view'))
          <li class="nav-item"><a class="nav-link {{ Request::is('paneladmin/email-center*') ? 'active' : '' }}" href="{{ route('paneladmin.email-center.index') }}"><div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"><i class="fas fa-mail-bulk text-sm opacity-10 {{ Request::is('paneladmin/email-center*') ? 'text-white' : 'text-dark' }}"></i></div><span class="nav-link-text ms-1">Email Center</span></a></li>
        @endif
        @if($can('roles.view'))
