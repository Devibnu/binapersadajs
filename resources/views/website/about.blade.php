    ...
    <div class="row">
        ...
        <div class="col-lg-6 mt-5 mt-lg-0">
          ...
          <div id="page-slider" class="page-slider small-bg">
              ...
              <div class="item" style="background-image:url({{ asset('web/images/slider-pages/slide-page1.jpg') }})">
                <div class="container">
              ...
              <div class="item" style="background-image:url({{ asset('web/images/slider-pages/slide-page2.jpg') }})">
                <div class="container">
                    <div class="box-slider-content">
                      <div class="box-slider-text">
              ...
              <div class="item" style="background-image:url({{ asset('web/images/slider-pages/slide-page3.jpg') }})">
                <div class="container">
                    <div class="box-slider-content">
                      <div class="box-slider-text">
        ...
        <div class="row">
          <div class="col-md-3 col-sm-6 ts-facts">
              <div class="ts-facts-img">
                <img loading="lazy" src="{{ asset('web/images/icon-image/fact1.png') }}" alt="facts-img">
              </div>
          ...
          <div class="col-md-3 col-sm-6 ts-facts mt-5 mt-sm-0">
              <div class="ts-facts-img">
                <img loading="lazy" src="{{ asset('web/images/icon-image/fact2.png') }}" alt="facts-img">
              </div>
              <div class="ts-facts-content">
          ...
          <div class="col-md-3 col-sm-6 ts-facts mt-5 mt-md-0">
              <div class="ts-facts-img">
                <img loading="lazy" src="{{ asset('web/images/icon-image/fact3.png') }}" alt="facts-img">
              </div>
              <div class="ts-facts-content">
          ...
          <div class="col-md-3 col-sm-6 ts-facts mt-5 mt-md-0">
              <div class="ts-facts-img">
                <img loading="lazy" src="{{ asset('web/images/icon-image/fact4.png') }}" alt="facts-img">
              </div>
              <div class="ts-facts-content">
        ...
        <div class="col-lg-12">
          <div id="team-slide" class="team-slide">
              <div class="item">
                <div class="ts-team-wrapper">
                    <div class="team-img-wrapper">
                      <img loading="lazy" class="w-100" src="{{ asset('web/images/team/team1.jpg') }}" alt="team-img">
                    </div>
              ...
              <div class="item">
                <div class="ts-team-wrapper">
                    <div class="team-img-wrapper">
                      <img loading="lazy" class="w-100" src="{{ asset('web/images/team/team2.jpg') }}" alt="team-img">
                    </div>
                    <div class="ts-team-content">
              ...
              <div class="item">
                <div class="ts-team-wrapper">
                    <div class="team-img-wrapper">
                      <img loading="lazy" class="w-100" src="{{ asset('web/images/team/team3.jpg') }}" alt="team-img">
                    </div>
                    <div class="ts-team-content">
              ...
              <div class="item">
                <div class="ts-team-wrapper">
                    <div class="team-img-wrapper">
                      <img loading="lazy" class="w-100" src="{{ asset('web/images/team/team4.jpg') }}" alt="team-img">
                    </div>
                    <div class="ts-team-content">
              ...
              <div class="item">
                <div class="ts-team-wrapper">
                    <div class="team-img-wrapper">
                      <img loading="lazy" class="w-100" src="{{ asset('web/images/team/team5.jpg') }}" alt="team-img">
                    </div>
                    <div class="ts-team-content">
              ...
              <div class="item">
                <div class="ts-team-wrapper">
                    <div class="team-img-wrapper">
                      <img loading="lazy" class="w-100" src="{{ asset('web/images/team/team6.jpg') }}" alt="team-img">
                    </div>
                    <div class="ts-team-content">
