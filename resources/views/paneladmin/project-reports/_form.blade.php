...
<div class="card shadow-sm border-0 mb-4">
  <div class="card-header bg-transparent border-0 pb-0"><h6 class="mb-0">Project Attachments</h6></div>
  <div class="card-body">
    @if($projectReport->exists && $projectReport->attachments?->isNotEmpty())
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="border rounded p-3 h-100">
              ...
              <div class="d-flex align-items-center justify-content-between gap-2">
                <a href="{{ route('paneladmin.project-report-attachments.download', $attachment) }}" class="btn btn-sm btn-outline-primary mb-0">
      ...
      <div class="alert alert-secondary text-sm">
        Centang attachment yang ingin dihapus, lalu klik Simpan Project Report.
      </div>
    @elseif($projectReport->exists)
    ...
    <div class="mb-3">
      ...
      <div class="form-text">Maksimal 10MB per file. Format PDF, JPG, JPEG, atau PNG.</div>
