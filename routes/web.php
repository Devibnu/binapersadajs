...
Route::prefix('paneladmin')->group(function () {
    ...
    Route::get('/', [DashboardController::class, 'index'])->middleware('permission:dashboard.view')->name('paneladmin.dashboard');
        ...
        Route::get('/about-videos', [AboutVideoController::class, 'index'])->middleware('permission:about-videos.view')->name('paneladmin.about-videos.index');
        Route::get('/about-videos/create', [AboutVideoController::class, 'create'])->middleware('permission:about-videos.create')->name('paneladmin.about-videos.create');
        Route::post('/about-videos', [AboutVideoController::class, 'store'])->middleware('permission:about-videos.create')->name('paneladmin.about-videos.store');
        Route::get('/about-videos/{aboutVideo}', [AboutVideoController::class, 'show'])->middleware('permission:about-videos.view')->name('paneladmin.about-videos.show');
        Route::get('/about-videos/{aboutVideo}/edit', [AboutVideoController::class, 'edit'])->middleware('permission:about-videos.update')->name('paneladmin.about-videos.edit');
        Route::put('/about-videos/{aboutVideo}', [AboutVideoController::class, 'update'])->middleware('permission:about-videos.update')->name('paneladmin.about-videos.update');
        Route::delete('/about-videos/{aboutVideo}', [AboutVideoController::class, 'destroy'])->middleware('permission:about-videos.delete')->name('paneladmin.about-videos.destroy');
        Route::get('/music-playlists', [MusicPlaylistController::class, 'index'])->middleware('permission:music-playlists.view')->name('paneladmin.music-playlists.index');
        Route::get('/music-playlists/create', [MusicPlaylistController::class, 'create'])->middleware('permission:music-playlists.create')->name('paneladmin.music-playlists.create');
        Route::post('/music-playlists', [MusicPlaylistController::class, 'store'])->middleware('permission:music-playlists.create')->name('paneladmin.music-playlists.store');
        Route::get('/music-playlists/{musicPlaylist}', [MusicPlaylistController::class, 'show'])->middleware('permission:music-playlists.view')->name('paneladmin.music-playlists.show');
        Route::get('/music-playlists/{musicPlaylist}/edit', [MusicPlaylistController::class, 'edit'])->middleware('permission:music-playlists.update')->name('paneladmin.music-playlists.edit');
        Route::put('/music-playlists/{musicPlaylist}', [MusicPlaylistController::class, 'update'])->middleware('permission:music-playlists.update')->name('paneladmin.music-playlists.update');
        Route::delete('/music-playlists/{musicPlaylist}', [MusicPlaylistController::class, 'destroy'])->middleware('permission:music-playlists.delete')->name('paneladmin.music-playlists.destroy');
