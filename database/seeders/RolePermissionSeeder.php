...
class RolePermissionSeeder extends Seeder
{
    public function run(): void
    {
        $definitions = [
            ...
            'Email Templates' => ['email-templates.view' => 'Lihat email template', 'email-templates.update' => 'Ubah email template', 'email-templates.test' => 'Kirim test email template'],
            'Email Center' => ['email-center.view' => 'Lihat email center', 'email-center.compose' => 'Tulis email', 'email-center.reply' => 'Balas email', 'email-center.forward' => 'Forward email', 'email-center.delete' => 'Hapus email', 'email-center.manage-accounts' => 'Kelola email accounts'],
            ...
            'Leads' => ['leads.view' => 'Lihat leads', 'leads.update' => 'Ubah status leads', 'leads.email' => 'Kirim email leads', 'leads.delete' => 'Hapus leads'],
            ...
            'Project Reports' => ['project-reports.view' => 'Lihat project reports', 'project-reports.create' => 'Tambah project reports', 'project-reports.update' => 'Ubah project reports', 'project-reports.delete' => 'Hapus project reports'],
            'Invoice Reports' => ['invoice-reports.view' => 'Lihat invoice reports', 'invoice-reports.create' => 'Tambah invoice reports', 'invoice-reports.update' => 'Ubah invoice reports', 'invoice-reports.delete' => 'Hapus invoice reports'],
            ...
            'Trading Products' => ['trading-products.view' => 'Lihat trading products', 'trading-products.create' => 'Tambah trading products', 'trading-products.update' => 'Ubah trading products', 'trading-products.delete' => 'Hapus trading products'],
        ...
        $contentAdmin->permissions()->sync(Permission::whereIn('slug', [
            ...
            'trading-products.view', 'trading-products.create', 'trading-products.update', 'trading-products.delete',
            ...
            'analytics.view',
            'email-templates.view', 'email-templates.update', 'email-templates.test',
            'email-center.view', 'email-center.compose', 'email-center.reply', 'email-center.forward', 'email-center.delete', 'email-center.manage-accounts',
            'leads.view',
            'inquiry-quotation.view', 'inquiry-quotation.create', 'inquiry-quotation.edit', 'inquiry-quotation.delete',
            'project-reports.view', 'project-reports.create', 'project-reports.update', 'project-reports.delete',
            'invoice-reports.view', 'invoice-reports.create', 'invoice-reports.update', 'invoice-reports.delete',
        ...
        $supportAdmin->permissions()->sync(Permission::whereIn('slug', [
            ...
            'leads.view', 'leads.update', 'leads.email',
            'email-center.view', 'email-center.compose', 'email-center.reply', 'email-center.forward',
